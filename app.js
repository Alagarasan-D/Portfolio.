...
function downloadCV() {
    const resumeUrl = 'RESUME.pdf'; // The name of your uploaded PDF file
    const link = document.createElement('a');
    link.href = resumeUrl;
    link.download = 'ALAGARASAN_D_RESUME.pdf'; // Suggested download file name
    document.body.appendChild(link);
    link.click();
    document.body.removeChild(link);
}

// Ensure the downloadCV function is correctly called by the button
// (The button link in index.html will be updated to use this function)
